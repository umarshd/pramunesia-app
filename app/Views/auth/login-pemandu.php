  ...
  <div class="container-fluid">
    <div class="row h-100vh">
      ...
      <div class="col-lg-6 bg-main py-4 text-center">
        ...
        <h6 class="text-white">Masuk sebagai Pemandu Wisata</h6>
        ...
        <div class="text-center">
          <p class="my-3 text-3">
            <span>
              <a href="<?= base_url() ?>/wisatawan/login">
          ...
          <p class="">
            <span>
              <a class="text-3" href="<?= base_url() ?>/pemandu/registrasi">Registrasi Sekarang</a>
            </span>
          </p>
        </div>
      </div>
