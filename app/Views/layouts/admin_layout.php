...
<head>
  ...
  <title>Aplikasi Pendaftaran Sidang</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Pendaftaran Sidang</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav " id="sidebar-nav">
      ...
      <li class="nav-item nav-side">
        <a class="nav-link collapsed" data-bs-target="#components-dosen" data-bs-toggle="collapse" href="#">
          <i class="bi bi-person-square"></i>
          <span>Data Dosen</span>
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-dosen" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('/admin/dosen') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>Dosen</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('/admin/dosen/tambah') ?>" class="a ">
      ...
      <li class="nav-item nav-side">
        <a class="nav-link collapsed" data-bs-target="#components-sidang" data-bs-toggle="collapse" href="#">
          <i class="bi bi-calendar-check"></i>
          <span>Data Sidang</span>
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-sidang" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('/admin/sidang') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>Sidang</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('/admin/sidang/tambah') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>Tambah Sidang</span>
            </a>
          </li>
        </ul>
      </li>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      <br>
      Develop by <a href="https://linkedin.com/in/umar-sahid">Umar Sahid</a>
    </div>
  </footer><!-- End Footer -->
