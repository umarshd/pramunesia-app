    ...
    <div class="row h-100vh">
      ...
      <div class="col-lg-6 bg-main py-4 text-center">
        ...
        <div class="container">
          ...
          <?php endif ?>
          <form action="<?= base_url() ?>/wisatawan/registrasi/proses" method="post">
