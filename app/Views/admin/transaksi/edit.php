    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="card p-3">
          ...
          <?php endif ?>
          <form action="<?= base_url() ?>/admin/transaksi/edit/proses" method="post">
            <div class="row">
              <div class="col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group py-2">
                  ...
                  <div class="text-3">
                    <?= $transaksi['nama_wisatawan'] ?>
                  </div>
                  <input type="text" name="pemandu_id" value="<?= $transaksi['wisatawan_id'] ?>" hidden>
