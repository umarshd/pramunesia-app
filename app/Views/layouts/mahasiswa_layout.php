  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav " id="sidebar-nav">
      ...
      <li class="nav-item nav-side">
        <a class="nav-link collapsed" href="<?= base_url('/mahasiswa/dashboard') ?>">
      ...
      <li class="nav-item nav-side">
        <a class="nav-link collapsed" href="<?= base_url('/mahasiswa/pendaftaransidang') ?>">
      ...
      <li class="nav-item nav-side">
        <a class="nav-link collapsed" href="<?= base_url('/mahasiswa/pendaftaransidang/status') ?>">
          <i class="bi bi-list"></i>
          <span>Data Pendaftaran Sidang</span>
        </a>
      </li>
